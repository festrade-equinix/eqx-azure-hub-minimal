...
variable "admin_ssh_public_key" {
  description = "SSH public key for the VM admin user. If empty, a keypair is generated by Terraform and the private key is saved locally as generated_ssh_key.pem (gitignored)."
  type        = string
  default     = ""
}
